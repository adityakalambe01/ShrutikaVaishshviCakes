              ...
              {paintings.map((painting) => (
                ...
                >
                  ...
                  <div className="p-6 bg-white">
                    <p className="text-sm text-amber-600 font-semibold mb-2">By {painting.artist}</p>
                    <h3 className="text-xl font-bold text-foreground mb-2">{painting.title}</h3>
                    <p className="text-foreground/60 text-sm mb-4">{painting.description}</p>
                    <div className="flex justify-between items-center">
                      <span className="text-lg font-bold text-amber-600">₹{painting.price}</span>
